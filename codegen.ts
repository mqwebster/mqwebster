...
export const config: CodegenConfig = {
  ...
  generates: {
    ...
    "src/lib/__generated/sdk.ts": {
      documents: [
        "src/lib/contentful/graphql/**/*.graphql",
        "src/components/fragments/**/*.graphql", // Ensure all fragments are included
      ],
      plugins: [
        "typescript",
      ...
      config: {
        ...
        nonOptionalTypename: true, // Ensure __typename is always present
        flattenGeneratedTypes: true, // Simplify the generated types
      },
    },
  },
};
