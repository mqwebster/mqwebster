...
export const DirectionAwareHover = ({
  ...
  return (
    <motion.div
      ...
      ref={ref}
      className={cn(
        "w-full aspect-square bg-transparent rounded-lg overflow-hidden group/card relative hover:shadow-xl",
        className
      )}
    >
      <Link
          ...
          >
            ...
            >
              <Image
                alt="image"
                className={cn(
                  "h-full w-full object-cover object-left-top scale-[1.08]",
                  imageClassName
                )}
                width="1000"
                height="1000"
